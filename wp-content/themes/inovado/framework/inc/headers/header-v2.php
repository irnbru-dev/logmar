<header id="header-v2" class="header clearfix">
		...
		<div class="container header-v2-container">
			...
			<div class="sixteen columns clearfix">
				...
				<!--
				<div class="slogan">
					 <?php // echo pre_process_shortcode($data['text_hv2slogan']); ?> 
					
				</div>
				-->
				
				<div class="phone-top four columns clearfix offset-by-two">
				...
				<div class="phone-top four columns clearfix">
					<div><span>Москва</span><span><a rel="nofollow" itemprop="telephone" href="tel:+74994180670" title="Телефон +7 (499) 649-60-00">+7 (499) 649-60-00</a></span></div>
				</div>
